= image:iptc_sv_gradient_70x70.jpg[IPTC logo] Photo Metadata User Guide
...
This version of the User Guide was edited by (in alphabetical order): Annette Feldman (http://www.ap.org/[AP]), Brendan Quinn (https://iptc.org/[IPTC]), David Riecks (http://www.controlledvocabulary.com/[www.controlledvocabulary.com]/PLUS), Sarah Saunders (http://www.cepic.org/[CEPIC]), Jeff Sedlik (http://www.useplus.org/[PLUS]), Michael Steidl (https://iptc.org/[IPTC]).
...
* Original digital capture of a real life scene: _born digital images_
* Digitised from a negative on film: _from bw or colour negatives_
* Digitised from a positive on film: _from slides or transparencies_
* Digitised from a print on non-transparent medium: _from photographic prints or flat artworks_
* Created by software: _from computer or software generated images including designs, illustrations, and composite images_
