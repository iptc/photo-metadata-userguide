= image:iptc_sv_gradient_70x70.jpg[IPTC logo] Photo Metadata User Guide - ToDo Reference (2024)
...
* addition DONE: <<Accessibility Descriptions>> including Alt Text and Extended Description (new 2021.1) [David and Caroline]
...
* addition DONE: <<Contributor>> (new 2022.1) - consider if Rights Information is the best section for it [David/Brendan]
...
* adding DONE: <<Data Mining>> (new 2023.1) [David and Jeff]
