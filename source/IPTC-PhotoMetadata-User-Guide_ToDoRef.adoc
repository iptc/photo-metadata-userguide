= image:iptc_sv_gradient_70x70.jpg[IPTC logo] Photo Metadata User Guide - ToDo Reference (2023)
...
* Add DONE: a guideline about how to apply metadata to AI-generated images (outline: use Digital Source Type and Contributor - and more) [Brendan]
* ADD: <<Data Mining>> (new 2023.1) [David and Jeff] - in progress
* CHANGE: all links of the Field Reference Table should link to the field and not to the group [Michael]
* CHANGE: if a URL/URI is the data type of a listed field value: apply the URL as link to the field value [Michael]
...
|Term URI |http://cv.iptc.org/newscodes/digitalsourcetype/digitalCapture
...
|Term URI | http://cv.iptc.org/newscodes/digitalsourcetype/negativeFilm
...
|Term URI | http://cv.iptc.org/newscodes/digitalsourcetype/positiveFilm
...
|Term URI | http://cv.iptc.org/newscodes/digitalsourcetype/print
...
|Term URI | http://cv.iptc.org/newscodes/digitalsourcetype/minorHumanEdits
...
|Term URI | http://cv.iptc.org/newscodes/digitalsourcetype/compositeCapture
...
|Term URI | http://cv.iptc.org/newscodes/digitalsourcetype/algorithmicallyEnhanced
...
|Term URI | http://cv.iptc.org/newscodes/digitalsourcetype/dataDrivenMedia
...
|===
|Name (en) | Digital art
|Term URI | http://cv.iptc.org/newscodes/digitalsourcetype/digitalArt
...
|Term URI | http://cv.iptc.org/newscodes/digitalsourcetype/virtualRecording
...
|Term URI | http://cv.iptc.org/newscodes/digitalsourcetype/compositeSynthetic
...
|Term URI | http://cv.iptc.org/newscodes/digitalsourcetype/trainedAlgorithmicMedia
...
|Term URI | http://cv.iptc.org/newscodes/digitalsourcetype/algorithmicMedia
...
|Term URI | http://cv.iptc.org/newscodes/digitalsourcetype/softwareImage - RETIRED
...
* *Image Creator* is bound to the owner of the intellectual property of an image in many countries and there are first legal decisions that AI generated images are not considered as creative work generating an intellectual property.
...
*_(OR should we create a new entry in the contentprodpartyrole CV? The NAR WG suggested simply "generator")_*
...
* Currently there is no good place to put the prompt given to the Generative AI engine used to generate the image. If you would like the IPTC to add a field to allow this, please let us know.
