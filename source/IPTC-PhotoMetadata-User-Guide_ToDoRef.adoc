...
In the Generative AI context, the URI value https://cv.iptc.org/newscodes/contentprodpartyrole/origcont should be used as it expresses “Content Originator = a party which originated the content of the item”. +
